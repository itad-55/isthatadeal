    ...
    for i, d in enumerate(deals):
        ...
        if i == 0:
            deal_rows += (
                ...
                f'<div class="dw-label" style="font-size:16px;letter-spacing:0.1em;text-transform:uppercase;color:rgba(255,255,255,0.4);font-family:monospace;margin-bottom:12px">Deal of the week</div>'
                ...
                f'<div class="dw-desc" style="font-size:17px;color:rgba(255,255,255,0.55);margin-bottom:8px;line-height:1.3">{item_name_raw}</div>'
                ...
                f'<div class="also-label" style="font-size:16px;letter-spacing:0.08em;text-transform:uppercase;color:#8A8680;font-family:monospace">Also worth buying this week</div>'
                f'</td></tr>'
            )
        else:
            deal_rows += (
                ...
                f'<div class="li-meta" style="font-size:16px;color:#8A8680;font-family:monospace;margin-bottom:10px">{store_line}{flipp_verify}</div>'
                ...
                f'<div style="font-size:15px;color:#8A8680;font-family:monospace;margin-bottom:4px">{kg_price if is_per_kg or raw_unit=="lb" else ""}</div>'
