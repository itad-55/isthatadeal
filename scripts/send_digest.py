    ...
    for i, d in enumerate(deals):
        ...
        if i == 0:
            deal_rows += (
                ...
                f'<div class="dw-label" style="font-size:13px;letter-spacing:0.1em;text-transform:uppercase;color:rgba(255,255,255,0.4);font-family:monospace;margin-bottom:10px">Deal of the week</div>'
                ...
                f'<div class="also-label" style="font-size:13px;letter-spacing:0.08em;text-transform:uppercase;color:#8A8680;font-family:monospace">Also worth buying this week</div>'
                f'</td></tr>'
            )
        else:
            deal_rows += (
