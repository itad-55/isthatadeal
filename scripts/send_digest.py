    ...
    for i, d in enumerate(deals):
        ...
        if i == 0:
            deal_rows += (
                ...
                f'<tr><td class="dw-inner" style="padding:14px">'
                f'<div class="dw-label" style="font-size:24px;letter-spacing:0.1em;text-transform:uppercase;color:rgba(255,255,255,0.4);font-family:monospace;margin-bottom:14px">Deal of the week</div>'
                f'<div style="font-size:36px;margin-bottom:10px">{em}</div>'
                f'<div class="dw-name" style="font-size:38px;font-weight:700;color:#FAFAF7;margin-bottom:6px;line-height:1.2">{d["name"]}</div>'
                f'<div class="dw-desc" style="font-size:26px;color:rgba(255,255,255,0.55);margin-bottom:10px;line-height:1.3">{item_name_raw}</div>'
                f'<div class="dw-meta" style="font-size:24px;color:rgba(255,255,255,0.4);font-family:monospace;margin-bottom:18px">{store_line}{flipp_verify}</div>'
                f'<div class="dw-price" style="font-size:52px;font-weight:700;color:#FAFAF7;font-family:monospace;margin-bottom:4px">{primary_price}</div>'
                f'<div style="font-size:24px;color:rgba(255,255,255,0.45);font-family:monospace;margin-bottom:12px">{kg_price if is_per_kg or raw_unit=="lb" else ""}</div>'
                f'<div class="dw-pct" style="font-size:26px;font-weight:700;color:#5DCAA5;font-family:monospace">{check} {pct_below}% below the Ontario average</div>'
                f'</td></tr></table></td></tr>'
                f'<tr><td style="padding:8px 12px 4px">'
                f'<div class="also-label" style="font-size:24px;letter-spacing:0.08em;text-transform:uppercase;color:#8A8680;font-family:monospace">Also worth buying this week</div>'
                f'</td></tr>'
            )
        else:
            deal_rows += (
                f'<tr><td class="li-row" style="padding:12px 16px;border-top:1px solid #E8E6DF">'
                f'<table width="100%" cellpadding="0" cellspacing="0"><tr>'
                f'<td width="72" style="vertical-align:top;padding-right:16px">'
                f'<div style="width:68px;height:68px;border-radius:14px;background:#F2F1EC;text-align:center;line-height:68px;font-size:38px">{em}</div>'
                f'</td>'
                f'<td style="vertical-align:top">'
                f'<div class="li-name" style="font-size:32px;font-weight:700;color:#0D0D0D;margin-bottom:4px;line-height:1.2">{d["name"]}</div>'
                f'<div class="li-desc" style="font-size:26px;color:#555555;margin-bottom:5px;line-height:1.3">{item_name_raw}</div>'
                f'<div class="li-meta" style="font-size:24px;color:#8A8680;font-family:monospace;margin-bottom:12px">{store_line}{flipp_verify}</div>'
                f'<div class="li-price" style="font-size:38px;font-weight:700;color:#0D0D0D;font-family:monospace;margin-bottom:2px">{primary_price}</div>'
                f'<div style="font-size:22px;color:#8A8680;font-family:monospace;margin-bottom:5px">{kg_price if is_per_kg or raw_unit=="lb" else ""}</div>'
                f'<div style="font-size:24px;font-weight:700;color:{color};font-family:monospace">{check} {pct_below}% below avg</div>'
                f'</td></tr></table></td></tr>'
            )
